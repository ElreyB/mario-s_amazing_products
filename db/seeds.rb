...
50.times do
  ...
  products = Product.create!(name: Faker::Commerce.product_name, cost: Faker::Commerce.price, country_of_origin: Faker::Address.country, image: Faker::LoremPixel.image("900x900", false, image_category[rand(0..image_category.length-1)], index), created_at: Faker::Date.between_except(1.year.ago, 1.year.from_now, Date.today))
